...
`mert_shockcord`, camera yaw +4.0 deg, elevation 28.0 deg, 0.62x fit distance.
Subject: **3D-printed rocket shock cord protector, PETG**
...
> 3D-printed rocket shock cord protector, PETG, studio product photograph, single large softbox from upper left
...
> 3D-printed rocket shock cord protector, PETG, product photography, studio lighting, dark seamless backdrop,
